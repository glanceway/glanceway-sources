...
const ja: Record<TranslationKey, string> = {
  ...
  "features.aiCreate.description": "Glanceway スキルを AI コーディングアシスタントに追加し、必要なデータを説明するだけで、インポート可能なソースが生成されます。",
  ...
  "features.aiCreate.step1": "Glanceway スキルをダウンロード",
  "features.aiCreate.step2": "Claude Code / Cursor / Windsurf に追加",
  "features.aiCreate.step3": "欲しいデータを説明 — 生成された .gwsrc ファイルをインポート",
