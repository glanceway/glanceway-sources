...
const ar: Record<TranslationKey, string> = {
  ...
  "features.aiCreate.description": "أضف مهارة Glanceway إلى مساعد البرمجة بالذكاء الاصطناعي، صف البيانات التي تريدها واحصل على مصدر جاهز للاستيراد.",
  ...
  "features.aiCreate.step1": "تنزيل مهارة Glanceway",
  "features.aiCreate.step2": "إضافتها إلى Claude Code / Cursor / Windsurf",
  "features.aiCreate.step3": "صف ما تريده — استورد ملف .gwsrc المُنشأ",
