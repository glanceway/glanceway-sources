...
const zh: Record<TranslationKey, string> = {
  ...
  "hero.title": "一瞥",
  "hero.description":
    "轻量级 macOS 菜单栏应用，聚合 Hacker News、GitHub、Reddit、RSS 订阅、股票行情、加密货币、开发者工具等信息源。支持用 AI 或代码创建自定义信息源。",
  ...
  "features.aiCreate.description": "将 Glanceway 技能添加到你的 AI 助手，描述你需要的数据，即可获得可直接导入的信息源。",
  ...
  "features.aiCreate.step1": "将 Glanceway 技能添加到你的 AI 助手",
  "features.aiCreate.codeCommand": "npx skills add glanceway/skills",
  "features.aiCreate.step2": "描述你想要的数据",
  "features.aiCreate.step3": "将生成的 .gwsrc 文件导入 Glanceway",
  ...
  "features.rss.description": "原生 RSS/Atom 支持。粘贴任意订阅链接，或使用 RSSHub / rss.app 获取数千种订阅源。",
  ...
  // SEO
  "seo.homeTitle": "macOS 菜单栏信息中心 — RSS、新闻和自定义信息源 | Glanceway",
  "seo.sourcesTitle": "macOS 菜单栏信息源 — Hacker News、GitHub、RSS 等 | Glanceway",
