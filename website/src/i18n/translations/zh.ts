...
const zh: Record<TranslationKey, string> = {
  ...
  "features.aiReading.chatUser": "帮我总结 Hacker News 动态",
  "features.aiReading.chatStatus": "正在通过 Glanceway 读取 3 个信息源...",
  "features.aiReading.chatResponse": "今日热门文章聚焦于<b>开源 AI 工具</b>和 <b>Rust 的采用</b>。一篇关于新代码编辑器的 Show HN 帖子以 342 分登上榜首。",
