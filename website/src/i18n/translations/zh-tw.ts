...
const zhTw: Record<TranslationKey, string> = {
  ...
  "features.aiCreate.description": "將 Glanceway 技能加入你的 AI 助手，描述你需要的資料，即可取得可直接匯入的資料來源。",
  ...
  "features.aiCreate.step1": "將 Glanceway 技能加入你的 AI 助手",
  "features.aiCreate.codeCommand": "npx skills add glanceway/skills",
  "features.aiCreate.step2": "描述你想要的資料",
  "features.aiCreate.step3": "將產生的 .gwsrc 檔案匯入 Glanceway",
