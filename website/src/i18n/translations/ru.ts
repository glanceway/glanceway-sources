...
const ru: Record<TranslationKey, string> = {
  ...
  "features.aiCreate.description": "Добавьте навык Glanceway в ваш ИИ-ассистент, опишите нужные данные и получите готовый к импорту источник.",
  ...
  "features.aiCreate.step1": "Добавьте навык Glanceway в ваш AI-ассистент",
  "features.aiCreate.codeCommand": "npx skills add glanceway/skills",
  "features.aiCreate.step2": "Опишите, какие данные вам нужны",
  "features.aiCreate.step3": "Импортируйте сгенерированный файл .gwsrc в Glanceway",
