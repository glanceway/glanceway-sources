const en = {
  ...
  "features.aiReading.chatUser": "Summarize my Hacker News feed",
  "features.aiReading.chatStatus": "Reading 3 sources via Glanceway...",
  "features.aiReading.chatResponse": "Today's top stories focus on <b>open-source AI tools</b> and <b>Rust adoption</b>. A Show HN post about a new code editor reached #1 with 342 points.",
